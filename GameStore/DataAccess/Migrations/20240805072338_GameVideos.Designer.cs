...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240805072338_GameVideos")]
    partial class GameVideos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Models.GameImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccess.Models.GameVideo", b =>
                {
            ...
            modelBuilder.Entity("DataAccess.Models.GameImage", b =>
                {
                    b.HasOne("DataAccess.Models.Game", "Games")
                        .WithOne("GameImage")
                        .HasForeignKey("DataAccess.Models.GameImage", "GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DataAccess.Models.GameVideo", b =>
                {
                    b.HasOne("DataAccess.Models.Game", "Game")
                        .WithOne("GameVideo")
                        .HasForeignKey("DataAccess.Models.GameVideo", "GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DataAccess.Models.OrderDetail", b =>
                {
                    b.HasOne("DataAccess.Models.GameCode", "GameCode")
